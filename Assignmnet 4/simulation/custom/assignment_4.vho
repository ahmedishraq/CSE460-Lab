...
-- Equation(s):
-- \cash_return~211_combout\ = \cash_in~dataout\(0) & \cash_in~dataout\(1)
...
-- Equation(s):
-- \next_state~reg0_regout\ = DFFEA(\cash_in~dataout\(1) & (\next_state~reg0_regout\ $ !\cash_in~dataout\(0)), GLOBAL(\clk~dataout\), !GLOBAL(\reset~dataout\), , , , )
...
-- Equation(s):
-- \cash_return[0]~reg0_regout\ = DFFEA(\cash_in~dataout\(1) & (\next_state~reg0_regout\) # !\cash_in~dataout\(1) & \cash_in~dataout\(0), GLOBAL(\clk~dataout\), !GLOBAL(\reset~dataout\), , \cash_return[0]~212_combout\, , )
...
-- Equation(s):
-- \cash_return[1]~reg0_regout\ = DFFEA(\cash_return[1]~reg0_regout\ & (\cash_return~211_combout\ # \next_state~reg0_regout\ & !\cash_in~dataout\(1)) # !\cash_return[1]~reg0_regout\ & (\next_state~reg0_regout\ & !\cash_in~dataout\(1)), GLOBAL(\clk~dataout\), 
...
-- Equation(s):
-- \cash_return[0]~217_regout\ = DFFEA(\cash_in~dataout\(1) & (\next_state~reg0_regout\) # !\cash_in~dataout\(1) & \cash_in~dataout\(0), GLOBAL(\clk~dataout\), !GLOBAL(\reset~dataout\), , \cash_return[0]~212_combout\, , )
